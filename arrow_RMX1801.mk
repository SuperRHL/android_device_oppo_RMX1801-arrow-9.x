...
PRODUCT_NAME := arrow_RMX1801PRODUCT_DEVICE := RMX1801PRODUCT_BRAND := oppo
PRODUCT_MODEL := Realme 2 ProPRODUCT_MANUFACTURER := oppo

PRODUCT_GMS_CLIENTID_BASE := android-oppo

TARGET_VENDOR := oppo
TARGET_VENDOR_PRODUCT_NAME := RMX1801TARGET_VENDOR_DEVICE_NAME := RMX1801
